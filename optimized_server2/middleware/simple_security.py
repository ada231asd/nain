"""
Упрощенный middleware безопасности без сложных зависимостей
"""
import asyncio
import time
import re
...
class SimpleSecurityMiddleware:
    """Упрощенный middleware для защиты от атак"""
    ...
    async def __call__(self, request, handler):
        ...
        # Проверяем, что это действительно request объект
    ...
    async def _check_request_size(self, request) -> bool:
    ...
    async def _check_headers(self, request) -> bool:
    ...
    async def _check_request_body(self, request) -> bool:
    ...
    async def _check_url_params(self, request) -> bool:
...
def create_simple_security_middleware():
    """Создает экземпляр упрощенного middleware безопасности"""
