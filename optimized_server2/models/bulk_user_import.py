...
class BulkUserImport:
    ...
    async def create_users_bulk(self, users: List[Dict[str, Any]], org_unit_id: Optional[int] = None) -> Tuple[List[Dict[str, Any]], List[str]]:
        """
    ...
    async def import_users_from_excel(self, file_content: bytes, org_unit_id: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            created_users, creation_errors = await self.create_users_bulk(new_users, org_unit_id)
