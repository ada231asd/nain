...
class SetVoiceVolumeAPI:
    ...
    async def get_set_voice_volume_logs(self, request: Request) -> Response:
        """
        Получает логи установки уровня громкости
        GET /api/set-voice-volume/logs
        """
        try:
            # Читаем логи из файла
            log_file_path = 'logs/set_voice_volume.log'
            logs = []
